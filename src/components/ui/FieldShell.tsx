...
const FieldShell = ({
  ...
  const control = cloneElement(children, {
    ...
    style: {
      ...
      ...(typeof childProps.style === 'object' && childProps.style ? (childProps.style as Record<string, unknown>) : {}),
    },
  ...
  return (
    <div
      className={clsx(
        ...
        fullWidth && 'w-full',
        !invalid && 'border-border/45 bg-[rgba(var(--glass-rgb),0.62)] hover:border-border/60 hover:bg-[rgba(var(--glass-rgb),0.72)] focus-within:border-accent focus-within:bg-[rgba(var(--glass-rgb),0.78)] focus-within:shadow-[0_0_0_2px_rgba(var(--ring-rgb),0.35)]',
        invalid && 'border-red-500 shadow-[0_0_0_2px_rgba(239,68,68,0.28)] focus-within:border-red-500 focus-within:shadow-[0_0_0_2px_rgba(239,68,68,0.32)]',
