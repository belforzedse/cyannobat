...
export const providerCardCopy: Record<
  DashboardMode,
  { iconLabel: string; description: string; title: string }
> = {
  doctor: {
    iconLabel: 'بازه‌های زمانی شما',
    title: 'مدیریت برنامه زمانی',
    description:
      'بازه‌های حضور خود را تنظیم کنید. تغییرات بلافاصله در دسترس تیم پذیرش قرار می‌گیرد.',
  },
  receptionist: {
