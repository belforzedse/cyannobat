...
const modalToneStyles: Record<ModalTone, CSSProperties> = {
  surface: {
    background:
      'linear-gradient(155deg, color-mix(in srgb, var(--card) 90%, transparent), color-mix(in srgb, var(--card) 70%, transparent))',
  } as CSSProperties,
  muted: {
    background:
      'linear-gradient(155deg, color-mix(in srgb, var(--muted) 72%, transparent), color-mix(in srgb, var(--card) 65%, transparent))',
    borderColor: 'rgba(var(--muted-foreground-rgb, 78 94 120), 0.45)',
  } as CSSProperties,
  accent: {
    background:
      'linear-gradient(160deg, color-mix(in srgb, var(--accent-strong) 72%, rgba(255, 255, 255, 0.08)), color-mix(in srgb, var(--accent) 82%, rgba(255, 255, 255, 0.12)))',
    color: 'var(--accent-foreground, rgb(var(--fg-rgb)))',
    borderColor: 'rgba(var(--accent-rgb), 0.55)',
    boxShadow:
      '0 40px 80px -32px rgba(var(--accent-rgb), 0.35), inset 0 1px 0 rgba(255, 255, 255, 0.35)',
  } as CSSProperties,
};
