...
const formatSelectedSummary = (
  ...
  try {
    const dateLabel = new Intl.DateTimeFormat('fa-IR', { dateStyle: 'full' }).format(
      ...
      <Card variant="default" padding="lg" className="sm:rounded-3xl">
        <div className="flex flex-col items-end gap-1 sm:gap-2 text-right">
          ...
          <p className="text-xs leading-6 text-muted-foreground">
            ابتدا روز مناسب را انتخاب کنید و سپس از میان زمان‌های خالی آن روز، ساعت دقیق نوبت را
            مشخص کنید. همراه هر بازه، ارائه‌دهنده هماهنگ‌شده همان خدمت نمایش داده می‌شود.
          </p>
          {selectionSummary ? (
