  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          اطلاعات ورود شما با سیستم رزرو یکپارچه است. نقش‌های فعال:{' '}
          {roles.length > 0 ? roles.join('، ') : 'کاربر مهمان'}.
        </motion.p>
        <motion.div
          initial={{ opacity: prefersReducedMotion ? 1 : 0, y: prefersReducedMotion ? 0 : 8 }}
          animate={{ opacity: 1, y: 0 }}
        ...
        >
          <Card variant="accent" padding="lg" className="flex flex-col gap-4 text-right">
            ...
            <p className="text-sm leading-6 text-accent/90">
              شما به عنوان عضو کادر درمان وارد شده‌اید. برای مدیریت نوبت‌ها و بازه‌های زمانی، به
              پیشخوان کارکنان منتقل شوید.
            </p>
                  ...
                  >
                    ...
                    >
                      ...
                      <div className="flex flex-col gap-1 text-xs text-muted-foreground">
                        ...
                        <span>
                          زمان:{' '}
                          {new Date(appointment.start).toLocaleString('fa-IR', { hour12: false })}
                        </span>
      ...
      >
        <Card variant="default" padding="lg" className="flex flex-col gap-4 text-right">
          ...
          <div className="space-y-2 text-sm leading-6 text-muted-foreground">
            ...
            <p>
              نام کامل:{' '}
              <span className="font-semibold text-foreground">{userName || 'ثبت نشده'}</span>
            </p>
            <p>
              شماره تماس:{' '}
              <span className="font-semibold text-foreground">{userPhone || 'ثبت نشده'}</span>
            </p>
