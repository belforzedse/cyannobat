    ...
    <form onSubmit={handleSubmit} className="flex w-full max-w-sm flex-col gap-4 text-right">
      ...
      <label className="flex flex-col gap-2 text-sm text-foreground">
        ...
        <span className="text-xs text-muted-foreground">
          کد ملی ۱۰ رقمی بدون خط تیره یا فاصله، مانند 1234567890
        </span>
      </label>
      ...
      <div className="space-y-2">
        ...
        <p className="text-xs leading-6 text-muted-foreground">
          برای فعال‌سازی نوبت‌دهی، احراز هویت پیامکی و ثبت کد ملی هر دو ضروری هستند. تا تکمیل این
          مراحل، رمز عبور امن انتخاب کنید و آن را نزد خود نگه دارید.
        </p>
      </div>
    </form>
  );
