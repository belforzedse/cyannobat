        ...
        <div className="mt-4 sm:mt-5 lg:mt-6">
          {errorMessage ? (
            ...
            <div className="rounded-2xl border border-dashed border-white/30 bg-white/40 p-6 text-sm text-muted-foreground dark:border-white/15 dark:bg-black/30">
              در حال حاضر خدمتی برای رزرو آنلاین فعال نشده است. لطفاً بعداً مراجعه کنید یا با پذیرش
              تماس بگیرید.
            </div>
          ) : (
            <motion.div className={listContainerClasses} variants={listVariants} {...motionStates}>
